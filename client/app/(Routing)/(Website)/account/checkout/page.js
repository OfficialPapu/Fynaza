...
import PaymentMethod from "@/Components/Website/Account/Checkout/PaymentMethod";
...
export default function CheckoutPage() {
  ...
  const { selectedAddress } = useCheckoutActions();
          ...
          >
            <div className="p-4 sm:p-6 md:p-8">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 sm:gap-6">
                ...
                <Button
                  size="lg"
                  className="rounded-xl px-6 sm:px-10 py-5 sm:py-6 bg-gray-900 hover:bg-black text-white text-base sm:text-lg shadow-lg hover:shadow-xl transition-all duration-300 w-full sm:w-auto"
