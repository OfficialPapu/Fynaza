                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      <Input
                        ...
                        autoComplete="off"
                      />
                      {ShowPass.Password ? (<Eye className="absolute top-1/2 right-3 -translate-y-1/2 cursor-pointer h-5" onClick={() => { togglePasswordVisibility("Password") }} />) :
                        (<EyeOff className="absolute top-1/2 right-3 -translate-y-1/2 cursor-pointer h-5" onClick={() => { togglePasswordVisibility("Password") }} />)}
                    </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      <Input
                        ...
                        autoComplete="off"
                      />
                      {ShowPass.ConfirmPassword ? (<Eye className="absolute top-1/2 right-3 -translate-y-1/2 cursor-pointer h-5" onClick={() => { togglePasswordVisibility("ConfirmPassword") }} />) :
                        (<EyeOff className="absolute top-1/2 right-3 -translate-y-1/2 cursor-pointer h-5" onClick={() => { togglePasswordVisibility("ConfirmPassword") }} />)}
                    </div>
